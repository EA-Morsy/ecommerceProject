...
<div class="row content" style="width: 80%; margin: 0 auto;">
    ...
    <div class="card item-card">
        ...
        <div class="card-body">
            ...
            <a href="/view/{{$p['id']}}" style="width: 100%; margin:0 auto" class="btn btn-success view">VIEW</a>
            ...
            <a href="/deleteProduct/{{$p['id']}}" style="width: 100%; margin:0 auto" class="btn btn-danger view">DELETE</a>
            <a href="/updateProduct/{{$p['id']}}" style="width: 100%; margin:0 auto" class="btn btn-dark">Edit</a>
        </div>
    </div>
    @endforeach
