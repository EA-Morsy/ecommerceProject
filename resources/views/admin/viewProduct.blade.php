...
<nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="/api/viewAllProducts">All Products</a></li>
...
<div class="card mb-3  my-5 caard" >
  <div class="row g-0 ">
    <div class="col-md-5 image">
      <img src="{{asset($product->pic)}}" class="image"  width= "500px" height="450px" alt="...">
    </div>
    <div class="col-md-5 details">
      <div class="card-body boody"style="float:right;  margin-right:-120px; width:100%">
        <h3 class="card-title" style="text-transform:capitalize;">{{$product->name}}</h3>
        ...
        <p class="card-text info">{{$product->desc}} </p>
